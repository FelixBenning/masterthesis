...
begin
	...
	plot!(domain, f_2, linewidth=2, label="\$\\nabla f(x) = x+24\\quad (1<x<2)\$")
	plot!(domain, f_3, linewidth=2, label="\$\\nabla f(x) = 25x-24\\quad (2<x)\$")
	plot!(
		domain, f, color=:black, linestyle=:dot, linewidth=3, 
