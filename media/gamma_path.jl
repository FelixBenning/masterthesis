...
yticks=vcat(
	...
	[
		...
		for (idx, gamma) in zip(0:length(gammas)-1, gammas)
	]	
)
...
[[ResumableFunctions]]
deps = ["MacroTools"]
git-tree-sha1 = "607f463e9d4f747ccc14dc670cfe88a242948c86"
