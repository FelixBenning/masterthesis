...
implied. If you are familiar with Lyapunov functions you will not be surprised
by the next argument, following from the Gradient Flow equation
%
...
diagnalization of the Hessian}) to see
%
\begin{align*}
...
\(1-\lr\hesseEV_i\) is greater than one. Which repels this component
\(\langle \weights_0 - \minimum, v_i\rangle\) away from our vertex \(\minimum\).
This is a good thing, since \(\minimum\) is a maximum in this component. This
means we will walk down local minima and saddle points no matter the learning
...
one inversion. Lastly there are issues obtaining the Hessian in a stochastic
setting.
