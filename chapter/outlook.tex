...
And as we have used the Lipschitz continuity to justify its bound (\ref{eq:
...
This also includes the following two methods.
...
the direction with negative eigenvalues in these eigenspaces.
