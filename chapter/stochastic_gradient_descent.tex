...
\begin{theorem}[{\cite{bottouOptimizationMethodsLargeScale2018}}]
...
\begin{theorem}
	...
	achieve \(O(1/n)\) convergence is thus for example
	\begin{align*}
		\lr_n = \frac{1}{2\hesseEV_1(n+\frac{\condition}{2})}.
	\end{align*}
\end{theorem}
...
During the second phase it does not matter whether or not the learning rate is decreased
