...
which has no effect on the convergence rate. In the ``noise reduction'' phase
on the other hand, doubling the number of steps or the batch size has the same
...
\begin{lemma}\label{lem: SGD bound with noise}
	Let \(\Loss\in\strongConvex{\lbound}{\ubound}\), then we have
	\begin{align*}
		\E\|\Weights_{n+1} - \minimum\|^2
		\le \left(1-2\lr_n\tfrac{\ubound\lbound}{\ubound+\lbound}\right)
		\E\|\Weights_n - \minimum\|^2 + \lr_n^2 \underbrace{\E\|\martIncr_{n+1}\|^2}_{\le\stdBound^2\lbound\ubound}.
	\end{align*}
\end{lemma}
\begin{proof}
...
\begin{theorem}[Optimal Rates]
	For a \(\Loss\in\strongConvex{\lbound}{\ubound}\) with
	\begin{align*}
		\E\|\martIncr_n\|^2 \le \stdBound\lbound\ubound
	\end{align*}
	...
	\begin{align*}
		...
		\end{cases}.
	\end{align*}
	If \(n_0\) is the start of the asymptotic phase, then
	\begin{align*}
		\E\|\Weights_n - \minimum\|^2
		\le \begin{cases}
			\left(1-\frac{2}{(1+\condition^{-1})(1+\condition)}\right)^n\E\|\weights_0 -\minimum\|^2
			& n \le n_0\\
			\frac{\stdBound^2(1+\condition^{-1})(1+\condition)}{n+1} & n \ge n_0.
		\end{cases}
	\end{align*}
\end{theorem}
\begin{proof}
	...
	\begin{align*}
		...
		\E\|\Weights_n - \minimum\|^2 + 2\lr_n \stdBound^2\lbound\ubound
		\xeq{!} 0
	\end{align*}
	...
	treat our problem like the classical one. Here we get a linear convergence
	rate
	\begin{align*}
		\E\|\Weights_{n+1} - \minimum\|^2
