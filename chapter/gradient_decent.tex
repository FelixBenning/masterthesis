...
\end{figure}
%
\fxwarning{switch entirely to heat motivation}
...
\begin{theorem}
	...
	there exists \(\loss\in\lipGradientSet{\ubound}\)
...
\begin{proof}
	...
	%
	\begin{align*}
		\nabla \tilde{\loss}(\weights) = \graphLaplacian\weights + (\weights^{(1)} -1) e_1
	\end{align*}
	%
	...
	\begin{align*}
		...
		= \weights^{(1)}\langle \weights, e_1\rangle 
