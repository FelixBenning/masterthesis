...
While it is not too surprising that we got our back the learning rate from
Section~\ref{sec: visualize gd} as we simply provided lower and upper bounds on
the eigenvalues, it is still reassuring that this actually works out that way.
