...
While Lipschitz continuity of the gradient provides an upper
...
\begin{proof}
	...
	\begin{align*}
		\frac{1}{\Delta_{n+1}}
		&\ge \frac{1}{\Delta_n}
		+ \frac{\omega}{\|\weights_0-\minimum\|^2}\overbrace{\frac{\Delta_n}{\Delta_{n+1}}}^{\ge 1}
...
\subsubsection{Subgradient "Decent"}
