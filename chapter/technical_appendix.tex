...
\end{proof}
\begin{corollary}\label{cor-appendix: diminishing contraction}
	Let \(a_0 \in [0, 1/q)\) for \(q>0\) and define
	\begin{align*}
		a_{n+1} = (1-q a_n)a_n.
	\end{align*}
	Then we have
	...
	\end{align*}
	in particular \(a_n\in O(1/n)\).
\end{corollary}
\begin{proof}[Proof {\parencite[by][]{israelHowWorkOut2012}}]
	By induction \(0\le a_n \le a_{n-1} < 1/q\) where the induction step is
	\begin{align*}
		0 \le a_{n+1} = (1-qa_n) a_n \le a_n. 
	\end{align*}
