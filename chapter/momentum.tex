...
\begin{proof}
	...
	\end{align*}
	Okay so using the same detour over the exponential as in the SGD chapter
	(\ref{eq: detour over exponential bound}) we get
	\begin{align*}
	...
	\begin{align*}
		...
		&\le\underbrace{
			\left(\frac{n+b}{b}\right)^{-2\sqrt{\hesseEV_1}a}\|\weights_0 - \minimum\|^2
		}_{
	...
	now result in we can bound the variance
\end{proof}
\begin{remark}
