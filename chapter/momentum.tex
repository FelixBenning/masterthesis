...
\begin{algorithm}
	...
	\While{not converged}{
		...
		Select \(\gamma_{n+1}\in(0,1)\) such that
		\begin{algomathdisplay}
			\ubound\gamma_{n+1}^2 = \gamma_{n+1}\lbound+(1-\gamma_{n+1})\lbound_n
		\end{algomathdisplay}
		%
		\(\lbound_{n+1}\leftarrow \gamma_{n+1}\lbound+(1-\gamma_{n+1})\lbound_n\)\;
		...
		\(z_{n+1}\leftarrow \tfrac{1}{\lbound_{n+1}}
			\left[{\scriptstyle \gamma_{n+1}\lbound} y_{n+1} + {\scriptstyle (1-\gamma_{n+1})\lbound_n} z_n
