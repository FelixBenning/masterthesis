...
The Lipschitz constant could be estimated with the fact that Gradient Descent
...
\begin{align*}
	...
	\underbrace{\E\|\martIncr_{k+1}\|^2}_{\le \tilde{\stdBound}}.
\end{align*}
...
\begin{theorem}
	...
	\begin{align*}
		...
		+ \tilde{\stdBound}^2 O(n^{-1}+n^{-2\sqrt{\hesseEV_1} a}).
	\end{align*}
