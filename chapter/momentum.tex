...
\begin{figure}[h]
	...
	\caption{
		...
		different condition numbers \(\condition\). The approximations
		\(\momCoeff_n=\frac{t_n-1}{t_{n+1}}\) where \(t_1=1\) and
		\(t_n=\tfrac12(1+\sqrt{1+4t_n^2})\) and \(\momCoeff_n=\frac{n-1}{n+2}\)
		for the bad (\(\condition^{-1}=0\)) case seem to be popular in practice
		\parencite{rechtOptimization2013} (surprisingly, since the
		true recursion is not much more expensive).
	}
