...
\begin{algorithm}
	...
	\(n\leftarrow 0\)\;
	\While{not converged}{
		Select \(\gamma_n\) such that
		\begin{algomathdisplay}
			\ubound\gamma_n^2 = (1-\gamma_n)\lbound+\gamma_n\lbound_n
		\end{algomathdisplay}
		%
		\(\lbound_{n+1}\leftarrow (1-\gamma_n)\lbound+\gamma_n\lbound_n\)\;
	...
	\caption{General Schema of an Optimal Method (\citeauthor{nesterovLecturesConvexOptimization2018})}
\end{algorithm}
