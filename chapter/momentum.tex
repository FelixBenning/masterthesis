...
So why are we even considering Nesterov's Momentum then? While
...
to a local area around \(\weights_*\), \textcite[pp. 78-79, 93-94]{lessardAnalysisDesignOptimization2016}
gave an example of an \(\strongConvex{\lbound}{\ubound}\) function where
the heavy ball method is trapped in an attractive cycle instead of converging.
