...
\begin{algorithm}
	...
	\While{not converged}{
		...
		Select \(\weights_{n+1}\) such that \label{line: selecting next position}
...
\begin{lemma}
	...
	where
	\begin{align}
		\momCoeff_n = \frac{\gamma_n\lbound_n(1-\gamma_n)}{}
...
\begin{algorithm}
	...
	\While{not converged}{
		...
		\Else{
			...
			\begin{algomathdisplay}
				\gamma_n^2 = \gamma_n \tfrac1\condition + (1-\gamma_n) \gamma_{n-1}^2
			\end{algomathdisplay}
		}
