...
\usepackage{emptypage} % removes pagenumbers on empty pages
\makeatletter \@twosidefalse \makeatother

%%% GRAPHICS & PLOTS

% \usepackage{graphicx} % enable pictures
\usepackage{wrapfig} % textwrapping around figures
...
%%% MATH
\usepackage{mathtools} % mathtools fixes some things from amsmath and adds some new features
...
\begin{document}
	...
	\include{./chapter/stochastic_approximation}
