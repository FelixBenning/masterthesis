\documentclass[12pt, a4paper, BCOR=10mm, DIV=12]{scrbook}
...
\usepackage[final]{fixme} %final removes annotations %draft includes annotations
\fxsetup{theme=color}
...
%%% BIBLIOGRAPHY
\usepackage[style=authoryear, backend=biber, seconds=true, date=iso, urldate=iso, maxcitenames=2]{biblatex}
\addbibresource{references.bib}
\setcounter{biburlnumpenalty}{7000} % penalty 0-10000 for margin overlap after number
\setcounter{biburllcpenalty}{7000} % penalty for overlap after lower case letter
...
\birthdate{27 November 1996}
\birthplace{Nürtingen}
\MatNr{1501817}
\titellineI{High Dimensional Optimization}
% \titellineII{}
% \titellineIII{}
\subtitellineI{through the Lens of Machine Learning}
%\subtitellineII{}
